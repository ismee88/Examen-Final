            ...
            <div class="row">
                ...
                <div class="col-md-9 mt-3">
                    <ul class="nav justify-content-end">
                        ...
                        <span class="vr"></span>
                        <li class="nav-item">
                            <a class="nav-link nav1" href="{{url('/admin/home')}}">Admin</a>
                        </li>
                        <span class="vr"></span>
        ...
        <section class="section3">
            ...
            <div class="row" style="margin-top: 60px">
                <div class="col">
                    ...
                    <p style="font-size: 28px; margin-left: 70px; margin-top: 100px;">
                        Faster est le service VTC à la demande qui vous<br>
                        accompagnera en toute sécurité dans tous vos<br>
                        déplacements. 
                    </p>
                </div>
                <div class="col">
