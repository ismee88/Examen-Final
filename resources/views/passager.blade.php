...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <section class="section1">
            ...
            <div class="row text1">
                <h1 class="h1-text1">FASTER prend soin de ses passagers</h1>
                <p class="p1">
                    Faster est le service VTC à la demande qui vous accompagnera<br>
                    en toute sécurité dans tous vos déplacements locaux.<br>
                </p>
                <div class="col-md-3 mt-4">
                    <a href="{{('register')}}" class="btn btn-inscription" style="width: 50%; padding: 10px; color: black; font-size: 20px;"><big>INSCRIPTION</big></a>
                    <a href="{{('/home')}}" class="btn btn-inscription mt-2" style="width: 50%; padding: 10px; color: black; font-size: 20px;"><big>Commander</big></a>
                </div>
            </div>
        </section>
        ...
        <section class="section2">
            ...
            <div class="row">
                <div class="col bloc">
                    ...
                    <div style="text-align: center; margin-top: 50px; margin-right: 20px;">
                        <p class="offset-2" style="font-size: 26px;">
                            Activez l’application Faster.<br>
                ...
                <div class="col bloc">
                    <img class="section2-img3 offset-3" src="/images/etoile.png">
                    <div style="text-align: center; margin-top: 135px; margin-right: 95px;">
                        <p class="offset-2" style="font-size: 26px;">
